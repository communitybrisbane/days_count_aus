      ...
      {selectedIndex !== null && (
        <>
          ...
          <div className="fixed inset-0 z-40 flex justify-center">
            <div ref={swipePost.ref} className="relative w-full max-w-[430px] flex flex-col" style={{ paddingBottom: "calc(4rem + env(safe-area-inset-bottom, 0px))" }} {...swipePost.handlers}>
