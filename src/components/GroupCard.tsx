        ...
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {group.isOfficial && !isModeGroup && <span className="text-[10px] bg-accent-orange/10 text-accent-orange px-1.5 py-0.5 rounded-full shrink-0">Hobby</span>}
            ...
            {!cleared && (liveMessageText || group.lastMessageText) && (
            ...
            <div className="px-6 pb-4 space-y-2">
              <div className="flex items-center gap-2 flex-wrap text-sm text-gray-500">
                {!group.isOfficial && group.joinType === "friends" && (
                  <span className="bg-red-100 text-red-500 px-2.5 py-1 rounded-full text-xs">Friends only</span>
                )}
                {!group.isOfficial && group.joinType !== "friends" && (
