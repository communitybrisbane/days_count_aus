...
export default function RestrictedBanner() {
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-[100] bg-red-600 text-white text-center px-4 py-3 text-xs leading-snug" style={{ paddingTop: "max(0.75rem, var(--safe-top, 0px))" }}>
