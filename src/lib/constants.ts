...
/** Bottom navigation bar height (CSS value) — keep in sync with BottomNav h-10 + its safe-area padding */
export const NAV_HEIGHT = "calc(2.5rem + env(safe-area-inset-bottom, 0px))";
